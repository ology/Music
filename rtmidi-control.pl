...
while (1) {
    ...
    if ($msg && $msg->[0] eq 'note_on') {
        warn ddc($msg);
        if ($msg->[2] == 55) {
            delay_effect($midi_out, $msg, 60, $sleep[0], 1);
        }
        elsif ($msg->[2] == 54 || $msg->[2] == 59) {
            delay_effect($midi_out, $msg, 60, $sleep[1], 2);
        }
        elsif ($msg->[2] == 53 || $msg->[2] == 58 || $msg->[2] == 63) {
            delay_effect($midi_out, $msg, 60, $sleep[2], 3);
        }
        elsif ($msg->[2] == 52 || $msg->[2] == 57 || $msg->[2] == 62 || $msg->[2] == 67) {
            delay_effect($midi_out, $msg, 60, $sleep[3], 4);
        }
        elsif ($msg->[2] == 56 || $msg->[2] == 61 || $msg->[2] == 66) {
            delay_effect($midi_out, $msg, 60, $sleep[4], 5);
        }
        elsif ($msg->[2] == 60 || $msg->[2] == 65) {
            delay_effect($midi_out, $msg, 60, $sleep[5], 6);
        }
        elsif ($msg->[2] == 64) {
            delay_effect($midi_out, $msg, 60, $sleep[6], 7);
        }
        elsif ($msg->[2] == 84) {
            delay_effect($midi_out, $msg, 64, $sleep[0], 1);
        }
        elsif ($msg->[2] == 88 || $msg->[2] == 85) {
            delay_effect($midi_out, $msg, 64, $sleep[1], 2);
        }
        elsif ($msg->[2] == 92 || $msg->[2] == 89 || $msg->[2] == 86) {
            delay_effect($midi_out, $msg, 64, $sleep[2], 3);
        }
        elsif ($msg->[2] == 96 || $msg->[2] == 93 || $msg->[2] == 90 || $msg->[2] == 87) {
            delay_effect($midi_out, $msg, 64, $sleep[3], 4);
        }
        elsif ($msg->[2] == 97 || $msg->[2] == 94 || $msg->[2] == 91) {
            delay_effect($midi_out, $msg, 64, $sleep[4], 5);
        }
        elsif ($msg->[2] == 98 || $msg->[2] == 95) {
            delay_effect($midi_out, $msg, 64, $sleep[5], 6);
        }
        elsif ($msg->[2] == 99) {
            delay_effect($midi_out, $msg, 64, $sleep[6], 7);
        }
        elsif ($msg->[2] == 80) {
