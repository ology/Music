...
And here is an example of the Jingle Bells MIDI that plays at the
workshop:
...
Here is the prototype code they came up with for Santa:
    ...
    # Have sixteen measures of "duration.pitch" notes
    my @notes = qw(
        qn.E4 qn.E4 hn.E4
        qn.E4 qn.E4 hn.E4
    ...
    # Dazzle them with musical oranmentation (based on beat position for now)
    my %dazzle = (
